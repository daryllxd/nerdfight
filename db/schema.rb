...
ActiveRecord::Schema.define(version: 20170306195331) do
  ...
  create_table "match_answers", force: :cascade do |t|
    ...
    t.index ["match_id", "team_id"], name: "index_match_answers_on_match_id_and_team_id", unique: true, using: :btree
  ...
  create_table "match_questions", force: :cascade do |t|
    ...
    t.index ["match_id"], name: "index_match_questions_on_match_id", using: :btree
    t.index ["question_id"], name: "index_match_questions_on_question_id", using: :btree
  end
